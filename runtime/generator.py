...
if _KIT is None:
    raise RuntimeError("generator 需要共享内核 K.dsh_kit（由 KERNEL_BOOTSTRAP 注入）")
...
if _K is not None:
    _K.dsh_generator_api = _KIT.Api({"version": GENERATOR_VERSION, "dispatch": generator_dispatch,

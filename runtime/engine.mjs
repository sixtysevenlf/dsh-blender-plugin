...
import { CFG, PATHS, winToWsl, wslToWin, describeConfig, IS_WIN, PKG_ROOT, wslPathShared } from './config.mjs';
...
export function writeHeadlessScript(code) {
  ...
  const wanted = { dir: requested, win: path.win32.join(WIN_TMP, name), label: 'workDir' };

...
async function fetchView(port, spec, timeoutMs = 180000) {
    ...
    let meta = null;
    try {
        meta = JSON.parse(String(r.headers.get('x-dsh-view') || 'null'));
    }
    catch (e) {
        meta = null;
    }
...
export function apply(ctx, config) {
    ...
    ctx.effect(() => ctx.tools.register(vTool({
        ...
        async execute(argsIn) {
            ...
            const payload = (argsIn && argsIn.args && typeof argsIn.args === 'object') ? { ...argsIn.args } : {};
